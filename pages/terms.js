  ...
  window.__pages['/legal/terms'] = function() {
    return `
      <div class="mx-auto max-w-4xl px-6 py-20">
        <h1 class="text-3xl font-bold text-[#1B1B4B] mb-2">Terms of Service</h1>
        <p class="text-sm text-[#6a6a8a] mb-10">Last updated: March 1, 2026</p>

        <div class="prose prose-slate prose-sm max-w-none">

          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">1. Acceptance of Terms</h2>
          ...
          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">2. Service Description</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
          ...
          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">5. Paid Plans</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
          ...
          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">6. Acceptable Use</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
            Your use of the Service is subject to our <a href="/legal/acceptable-use" class="text-[#F9A825] hover:text-[#FFB830]">Acceptable Use Policy</a>, which is incorporated into these Terms by reference. Violation of the Acceptable Use Policy may result in suspension or termination of your account.
          </p>

          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">7. Service Level</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
          ...
          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">8. Limitation of Liability</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
          ...
          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">9. Termination</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
          ...
          <h2 class="text-lg font-semibold text-[#1B1B4B] mt-8 mb-3">10. Contact</h2>
          <p class="text-sm text-[#4a4a6a] leading-relaxed mb-4">
            For questions about these Terms of Service, contact us at
            <a href="mailto:legal@rapidcheck.com" class="text-[#F9A825] hover:text-[#FFB830]">legal@rapidcheck.com</a>.
          </p>
