  ...
  window.__pages['/pricing'] = function() {
    ...
    <section class="pt-24 sm:pt-28 md:pt-32 pb-16 relative">
        ...
        <div class="relative max-w-4xl mx-auto px-6 text-center z-10">
            ...
            <p class="text-base sm:text-lg text-zinc-400 max-w-xl mx-auto mb-2 leading-relaxed reveal-up" style="animation-delay: 0.2s;">
                ...
                <div class="relative bg-zinc-900/20 border border-white/5 rounded-2xl p-8 flex flex-col">
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-zinc-400">Perfect for personal projects and small sites.</p>
                        </div>
                ...
                <div class="relative bg-zinc-900/20 border-2 border-emerald-500/40 rounded-2xl p-8 flex flex-col">
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-zinc-400">Everything you need for production monitoring.</p>
                        </div>
                        <ul class="space-y-3 mb-8 flex-1">
                            <li class="flex items-start gap-3 text-sm text-zinc-300">
                                <svg class="w-4 h-4 mt-0.5 text-emerald-400 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
    ...
    <section class="py-20 border-y border-white/5 bg-zinc-900/20 relative">
        ...
        <div class="relative max-w-2xl mx-auto px-6 text-center z-10">
            ...
            <p class="text-sm text-zinc-400 mb-10">Drag the slider to see what you'd pay.</p>
            <div class="bg-zinc-900/40 border border-white/5 rounded-2xl p-8">
                <div class="mb-8">
                    <label for="monitor-slider" class="text-sm text-zinc-400 block mb-4">
                ...
                <div class="flex flex-col items-center gap-1">
                    ...
                    <p class="text-xs text-zinc-500 mt-3">
                        That's <span id="daily-cost" class="text-zinc-400 font-mono">$0.67</span>/day for <span id="cost-monitors" class="text-zinc-400 font-mono">10</span> monitors
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 relative">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-sm text-zinc-400">Everything included at a glance.</p>
            </div>
            <div class="border border-white/5 rounded-2xl overflow-hidden">
                <!-- Table Header -->
                <div class="grid grid-cols-3 bg-zinc-900/40 border-b border-white/5">
                    <div class="p-4 text-sm font-medium text-zinc-400">Feature</div>
                    <div class="p-4 text-sm font-medium text-zinc-400 text-center">Free</div>
                    <div class="p-4 text-sm font-medium text-emerald-400 text-center">Paid</div>
                </div>

                <!-- Uptime Monitoring -->
                <div class="grid grid-cols-3 bg-zinc-900/30 border-b border-white/5">
                    <div class="col-span-3 px-4 py-2.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Uptime Monitoring</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                    ...
                    <div class="p-4 text-sm text-zinc-400 text-center font-mono">3</div>
                ...
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                    ...
                    <div class="p-4 text-sm text-zinc-400 text-center font-mono">3 min</div>
                ...
                <!-- Domain Intelligence -->
                <div class="grid grid-cols-3 bg-zinc-900/30 border-b border-white/5">
                    <div class="col-span-3 px-4 py-2.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Domain Intelligence</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <!-- Alerting -->
                <div class="grid grid-cols-3 bg-zinc-900/30 border-b border-white/5">
                    <div class="col-span-3 px-4 py-2.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Alerting</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <!-- Status Pages -->
                <div class="grid grid-cols-3 bg-zinc-900/30 border-b border-white/5">
                    <div class="col-span-3 px-4 py-2.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Status Pages</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                    <div class="p-4 text-sm text-zinc-300">Public status pages</div>
                    <div class="p-4 text-sm text-zinc-400 text-center font-mono">1</div>
                    <div class="p-4 text-sm text-emerald-400 text-center font-mono">Unlimited</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <!-- Collaboration -->
                <div class="grid grid-cols-3 bg-zinc-900/30 border-b border-white/5">
                    <div class="col-span-3 px-4 py-2.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Collaboration</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <!-- Data & Support -->
                <div class="grid grid-cols-3 bg-zinc-900/30 border-b border-white/5">
                    <div class="col-span-3 px-4 py-2.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Data & Support</div>
                </div>
                <div class="grid grid-cols-3 border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                    <div class="p-4 text-sm text-zinc-300">Data retention</div>
                    <div class="p-4 text-sm text-zinc-400 text-center font-mono">30 days</div>
    ...
    <section class="py-20 border-t border-white/5 relative">
        ...
        <div class="relative max-w-3xl mx-auto px-6 z-10">
            <div class="text-center mb-12">
                ...
                <p class="text-sm text-zinc-400">Got questions? We have answers.</p>
            </div>
    ...
    <section class="py-20 border-t border-white/5 relative">
        ...
        <div class="relative max-w-2xl mx-auto px-6 text-center z-10">
            ...
            <p class="text-sm text-zinc-400 mb-8 max-w-lg mx-auto">3 monitors free forever. Full domain intelligence included. No credit card required.</p>
