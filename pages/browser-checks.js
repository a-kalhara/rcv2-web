    ...
    return `
      ...
      <div class="mx-auto max-w-4xl px-6 pb-20">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-20">
          ...
          <div class="rounded-xl border border-[#F9A825]/15 bg-white p-6 hover:bg-[#faf8f5] hover:border-[#F9A825]/30 transition-colors shadow-sm">
            <h3 class="text-[#1B1B4B] font-semibold mb-2">Cloud browser rendering</h3>
            <p class="text-sm text-[#4a4a6a]">Powered by cloud-native browser infrastructure. No browser infrastructure to manage — scales automatically with your monitoring needs.</p>
          </div>
        </div>
